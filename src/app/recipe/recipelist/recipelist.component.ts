...
export class RecipelistComponent implements OnInit {
	...
	recipes: Recipe[] = [
       new Recipe("Test Recipe 1", "Test Recipe Desc 1","https://static01.nyt.com/images/2015/08/14/dining/14ROASTEDSALMON/14ROASTEDSALMON-articleLarge.jpg"),
  ...
  getRecipeDetails(recipe: Recipe) {
     ...
     this.recipeDetailsDisplay.emit(recipe);
